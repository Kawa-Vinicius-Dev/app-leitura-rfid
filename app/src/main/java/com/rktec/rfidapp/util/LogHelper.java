...
public class LogHelper {
    ...
    public static void logRelatorioPorLoja(
        ...
        try {
            ...
            if (novoArquivo) {
                pw.println("Data/Hora,Usuário,Loja,Setor,Tipo,NroBem,Desc. Item,Plaqueta,Cód. Localização,Alterações");
            }
            ...
            for (ItemPlanilha item : itensMovidos) {
                ...
                pw.printf("%s,%s,%s,%s,MOVIDO,%s,%s,%s,%s,%n",
                        data, usuario, loja, setorItemNome,
                        item.nrobem != null ? item.nrobem : "",
                        item.descresumida != null ? item.descresumida : "",
                        item.nroplaqueta != null ? item.nroplaqueta : "",
                        item.codlocalizacao != null ? item.codlocalizacao : ""
                );
            }
            for (ItemPlanilha item : itensOutrasLojas) {
                String setorItemNome = buscarNomeSetorPorCodigo(item.codlocalizacao, listaSetores);
                pw.printf("%s,%s,%s,%s,OUTRA LOJA/SETOR,%s,%s,%s,%s,%n",
                        data, usuario, item.loja, setorItemNome,
                        item.nrobem != null ? item.nrobem : "",
                        item.descresumida != null ? item.descresumida : "",
                        item.nroplaqueta != null ? item.nroplaqueta : "",
                        item.codlocalizacao != null ? item.codlocalizacao : ""
    ...
    public static void logEdicaoItem(
        ...
        try {
            ...
            pw.printf("%s,%s,%s,%s,EDICAO,%s,%s,%s,%s,%s%n",
                    data, usuario, loja, setorNome,
                    itemNovo != null && itemNovo.nrobem != null ? itemNovo.nrobem : "",
                    itemNovo != null && itemNovo.descresumida != null ? itemNovo.descresumida : "",
                    itemNovo != null && itemNovo.nroplaqueta != null ? itemNovo.nroplaqueta : "",
                    itemNovo != null && itemNovo.codlocalizacao != null ? itemNovo.codlocalizacao : "",
    ...
    // Adiciona esse método no LogHelper
    public static void logRemocaoUsuario(Context context, String quemRemoveu, String quemRemovido, String motivo) {
        try {
            File arquivo = new File(context.getExternalFilesDir(null), "usuarios_removidos.csv");
            boolean novoArquivo = !arquivo.exists();
            ...
            if (novoArquivo) {
                pw.println("Data/Hora,Quem Removeu,Quem Foi Removido,Motivo");
            }

            String data = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(new Date());
            pw.printf("%s,%s,%s,%s%n", data, quemRemoveu, quemRemovido, motivo);
